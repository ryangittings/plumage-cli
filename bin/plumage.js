...
if (typeof cmd.args[0] === 'undefined') {
  ...
  if (typeof cmd.opts.version !== 'undefined') {
    process.stdout.write("Plumage CLI version " + require('../package.json').version + '\n');
  }
